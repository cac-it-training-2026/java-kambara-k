...
public class Question07_4 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		if (totalPrice >= 5000) {
			int discountTotalPrice = (int) (totalPrice * 0.9);
			int discountTaxIncludedTotalPrice = (int) (discountTotalPrice * 1.1);
			System.out.println("\n割引前合計 : " + totalPrice + " 円");
			System.out.println("割引適用（10%OFF）" + discountTotalPrice + " 円");
			System.out.println("税込合計" + discountTaxIncludedTotalPrice + " 円");
		} else {
			System.out.println("\n税込合計");
			System.out.println(taxIncludedTotalPrice + " 円");
		}
	}
}
